...
function get_todos() {
    ...
    /*if the input is not null then JSON.parse will communicate w the web browser to make the task a JS object*/
    if (todos_str !== null) {
...
function show() {
    ...
    /*this tells the browser how to display the to-do array after an item has been removed*/
...
/*function to remove a to-do item when user clicks the 'x' button*/
function remove() {
